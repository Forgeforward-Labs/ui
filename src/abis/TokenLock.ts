const abi = [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "newExpiration", type: "uint256" },
      { internalType: "uint256", name: "oldExpiration", type: "uint256" },
    ],
    name: "CanOnlyIncreaseExpiration",
    type: "error",
  },
  {
    inputs: [
      { internalType: "uint256", name: "end", type: "uint256" },
      { internalType: "uint256", name: "now", type: "uint256" },
    ],
    name: "LockNotEnded",
    type: "error",
  },
